...
<head>
    ...
    <link rel="icon" href="{{asset('public/frontend/images/fav-icon.png')}}" type="image/gif" sizes="32x32">
...
<!--                     <div class="col-sm-8">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <img src="{{('public/uploads/contact/logo12.png')}}" alt="" />
                        </div>
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © Truong Duc Thang a.k.a Dark Gosu</p>
...
<script type="text/javascript">
   ...
   function add_wistlist(clicked_id){
        ...
        if(matches.length){
           ...
           $('#row_wishlist').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+newItem.image+'"></div><div class="col-md-8 info_wishlist"><p>'+newItem.name+'</p><p style="color:#FF0000">'+newItem.price+'</p><a href="'+newItem.url+'">Đặt hàng</a></div>');
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('.add-to-cart').click(function(){
                ...
                var cart_product_colr = $('.cart_product_colr_' + id).val();
                var _token = $('input[name="_token"]').val();
